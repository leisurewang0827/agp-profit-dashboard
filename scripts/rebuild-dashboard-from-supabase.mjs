...
console.log(`- Main rows: ${mainRows.length}, latest ${latestDate(mainRows)}`);
console.log(`- Ad category rows: ${adDailyRows.length}, latest ${latestDate(adDailyRows)}`);
console.log(`- Ad channel rows: ${adChannelRows.length}, latest ${latestDate(adChannelRows)}`);
